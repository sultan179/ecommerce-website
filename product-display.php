...
?>
        ...
        <div class="row">
                <div class="col-sm-4">
                    ...
                    <img src="<?php echo substr($row['image_url'],1) ?>" alt="Elmasri textbook" class="img img-rounded">
                </div>
                <div class="col-sm-8">
                    <h3>Category: Used Items</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <?php if(!isset($_SESSION['user_email'])){
                                ?>
                                <button style="font-size: 16px;" type="button" class="btn btn-success text-left" disabled>Add to my cart</button><?php
                            }else{
                                ?>
                                <button data-id='<?php echo $row['id'] ?>' data-email="<?php echo $email ?>" style="font-size: 16px;" type="button" class="btn btn-success text-left" id="btn" >Add to my cart</button><?php
                            } ?>
                        </div>
                        <div class="col-sm-4">
                            <button style="font-size: 16px;" type="button" class="btn btn-info text-center">Contact Seller</button>
                        </div>
                        <div class="col-sm-4">
                            <a href="./index.php" style="font-size: 16px;" class="btn btn-danger text-right">Homepage</a>
                        </div>
